...
- **Estado:** En curso. Los sub-slices locales `OwnerWorkspaceShellV1` y `OwnerFieldDeepLinkV1` organizan superficies owner existentes y navegación privacy-safe por campo draft; roles adicionales, preferencias persistentes, matriz completa de navegadores y certificación WCAG del padre continúan pendientes.
