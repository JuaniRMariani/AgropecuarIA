...
Identity agrega además inventario privacy-safe de sesiones propias y revocación individual/bulk/global mediante purpose `manage_sessions`, CSRF, CAS y funciones actor-scoped. El cierre global incluye current y elimina la cookie sólo después del commit. No incorpora dispositivos, IP, user-agent, fingerprints, notificaciones ni propagación distribuida.
