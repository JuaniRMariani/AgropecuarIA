...
| Invitación one-shot de co-owner | Owner activo y step-up `manage_organization_owners` para crear/revocar; token bearer 256-bit visible una vez, sólo digest HMAC versionado; aceptación reciente crea membership+journal+outbox atómicos; errores neutrales, ETag, `FORCE RLS`, A/B/sin contexto/pool/job, expiración y carreras terminales | Envío/email, roles no-owner, remoción/democión/último owner, purge/retención legal, secretos administrados y entorno compartido |
