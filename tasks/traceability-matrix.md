...
Versión: 1.0 — 2026-08-04. Los rangos son inclusivos y representan cada ID individual del intervalo. `TST-*` son IDs lógicos de pruebas/evidencias; la futura implementación los vinculará con el runner real.
